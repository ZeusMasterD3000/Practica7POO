...
public class Principal {
    public static void main(String[] args) {
        ArrayList<ArrayList<DispositivoElectronico>> productos = new ArrayList<>(null);
        ArrayList<DispositivoElectronico> carritoDeCompras = new ArrayList<>(null);
        ArrayList<DispositivoElectronico> celulares = new ArrayList<>(null);
